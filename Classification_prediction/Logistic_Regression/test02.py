...
pipeline = Pipeline(steps=[
    ...
    ('classifier', LogisticRegression(max_iter=1000, multi_class='multinomial', solver='lbfgs', penalty='l2', C=100.0))
])
...
plt.tight_layout()
plt.savefig('Logistic Regression Error bar graph.png')
plt.show()
