...
plot_with_ci(axs[0,0], acc_mean, acc_ci, "Accuracy", (70, 100))
plot_with_ci(axs[0,1], prec_mean, prec_ci, "Precision", (60, 100))
plot_with_ci(axs[1,0], recall_mean, recall_ci, "Recall", (60, 100))
plot_with_ci(axs[1,1], f1_mean, f1_ci, "F1 Score", (60, 100))
plt.tight_layout()
plt.savefig('Naive Bayes Error bar graph.png')
plt.show()
